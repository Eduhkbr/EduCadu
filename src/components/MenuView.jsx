    ...
    return (
        <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
                ...
                <MenuButton bgColor="bg-orange-400" icon={<img src={animalsIcon} alt="Animals Icon" className="h-16 w-16 md:h-24 md:w-24 object-contain"/>} title={t('category_animals')} onClick={() => onSelectCategory('animals')}/>
            </div>
        </div>
    );
};
