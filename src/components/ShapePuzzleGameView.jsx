...
const ShapePuzzleGameView = ({ onGoHome, onGameWin }) => {
    ...
    // Verificar proximidade da zona de drop
    const isNearDropZone = (dragEndPosition) => {
        if (!dropZoneRef.current) {
            return false;
        }

        // Obter o retângulo da zona de drop
    ...
    // Efeito para gerar a primeira rodada
    useEffect(() => {
    ...
    return (
        <DndContext
            ...
            onDragEnd={({ active }) => {
                // Tentar obter o centro do elemento arrastado usando a ref
                ...
                // Verificar se a forma correta foi solta próxima ao alvo
