    ...
    return (
        <div className="w-full text-center text-[var(--text-color)]">
            ...
            <header className="py-16 md:py-24">
                <h1 className="text-4xl font-black md:text-6xl">{t('landing_title')}</h1>
            ...
            <main>
                ...
                <section className="py-12 bg-[var(--card-bg)] rounded-3xl">
                ...
                <section className="py-16 md:py-24">
                    <h2 className="text-3xl font-black md:text-4xl">{t('landing_for_parents_title')}</h2>
